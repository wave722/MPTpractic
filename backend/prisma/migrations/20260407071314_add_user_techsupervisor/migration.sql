...
CREATE TABLE "new_users" (
    ...
    "techSupervisorId" INTEGER,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "users_techSupervisorId_fkey" FOREIGN KEY ("techSupervisorId") REFERENCES "tech_supervisors" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
